...
from Retriever.coordinate_resolver import resolve_value_coordinates
...
def runner():
    ...
    for field in fields:
        ...
        resolved_output = resolve_value_coordinates(
        ...
        print(f"Resolved output for {field['field_name']}: {json.dumps(resolved_output, indent=2)}")
