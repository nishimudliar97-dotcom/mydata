CREATE OR REPLACE TABLE OPEN_MARKET_NTU_CLASSIFICATION_V4_OUTPUT (
...
CREATE OR REPLACE TABLE OPEN_MARKET_NTU_CLASSIFICATION_V4_ERROR_LOG (
    ACCOUNT_FOLDER_NAME STRING,
    ERROR_MESSAGE STRING,
    RAW_LLM_RESPONSE STRING,
    FILES_PROCESSED NUMBER,
    RUN_ID STRING,
    ERROR_CREATED_AT TIMESTAMP_NTZ DEFAULT CURRENT_TIMESTAMP()
);
