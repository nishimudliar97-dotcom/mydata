...
def get_folder_name(file_path):
    """
    Returns immediate parent folder of the file.
    Example:
    @STAGE/Open_Market/Insurer/Subfolder/file.pdf -> Subfolder
    @STAGE/Open_Market/Insurer/file.pdf -> Insurer
    """
...
def get_insurer_name(file_path):
    ...
    Example:
    @STAGE/Open_Market/A184429_Taylor_Preston/file.pdf
