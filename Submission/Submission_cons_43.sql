...
VARIABLES = {
    ...
    "YEAR_BUILT": {
        ...
        "ai_description": "Extract ONLY the original year built of the insured property/building. Valid values are years between 1000 and the current year. Do not return policy years, renewal years, report years, email dates, inspection dates, loss years, or unrelated years."
    },
    "YEAR_OF_LAST_MAJOR_RENOVATION": {
        ...
        "ai_description": "Extract ONLY the year of last major renovation or year of major structural upgrade for the insured property/building. Valid values are years between 1000 and the current year."
    },
    "SQUARE_FOOTAGE": {
        ...
        "ai_description": "Extract ONLY square footage, square feet, floor area, building area, building sq ft, or gross floor area for the insured property/building/location. Do not return TIV, values, limits, deductibles, or currency amounts."
    },
    "NUMBER_OF_STORIES": {
        ...
        "ai_description": "Extract ONLY number of stories/storeys for the insured property/building. Values may be like 1, 2, 3, or 2 & 3."
    },
    "NUMBER_OF_BASEMENTS": {
...
def ai_extract_variables_from_file(session, stage_name, relative_path):
    ...
    for variable_keys in variable_batches:
...
WHERE ACCOUNT_FOLDER_NAME ILIKE '%HORN%BARLOW%';
