CREATE OR REPLACE TABLE OPEN_MARKET_LOSS_FILE_SELECTION_3 (
    RUN_ID STRING,
...
CREATE OR REPLACE TABLE OPEN_MARKET_LOSS_HISTORY_EXTRACTION_3 (
    RUN_ID STRING,
    ACCOUNT_FOLDER STRING,
...
CREATE OR REPLACE TABLE OPEN_MARKET_LOSS_HISTORY_AGGREGATED_3 (
    RUN_ID STRING,
    ACCOUNT_FOLDER STRING,
...
CREATE OR REPLACE TABLE OPEN_MARKET_LOSS_PROCESSED_ACCOUNTS_3 (
    ACCOUNT_FOLDER STRING,
    LAST_RUN_ID STRING,
    STATUS STRING,
